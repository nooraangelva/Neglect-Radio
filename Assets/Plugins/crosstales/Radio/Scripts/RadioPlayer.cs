...
*/
               if (!LegacyMode && nextRecordDelay >= -0.1f && System.Math.Abs(lastNextRecordDelay - nextRecordDelay) > Util.Constants.FLOAT_TOLERANCE) //lastNextRecordDelay != nextRecordDelay)
               {
                              ...
                              do
                              {
                                 ...
                                 if ((_read = _stream.Read(_buffer, 0, _buffer.Length)) > 0)
                                 {
                                    ...
                                    */
                                    ...
                                    if (_nextRecordDelay < Util.Constants.FLOAT_TOLERANCE && recordInfo?.Equals(_nextRecordInfo) == false)
                                    {
