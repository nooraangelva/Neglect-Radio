namespace Crosstales.Radio.Util
{
   ...
   public abstract class Constants : Common.Util.BaseConstants
   {
      ...
      public const string ASSET_VERSION = "2021.2.3";

      /// <summary>Build number of the asset.</summary>
      public const int ASSET_BUILD = 20210928;
      ...
      public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2021, 9, 28);
